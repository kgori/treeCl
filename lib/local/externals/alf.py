...
class ALF(ExternalSoftware):
    ...
    def write(self):
        ...
        self.tree.scale(100, inplace=False).write_to_file('{0}/{1}.nwk'.format(
            self.param_dir, self.name), suppress_NHX=True)
...
#         sim.subst = self.parameters['subst']  # copy over global parameters
